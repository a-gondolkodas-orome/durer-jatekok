...
describe('Anti TicTacToe strategy', () => {
  describe('getGameStateAfterAiTurn', () => {
    it('should place to middle place as a starting move', () => {
      ...
      const result = getGameStateAfterAiTurn({ board, ctx: { chosenRoleIndex: 1 } });
    ...
    it('should place to central mirror image of item without mirror image', () => {
      expect(getGameStateAfterAiTurn({ board: [
        ...
        null, 'red', null,
        null, null, null
      ], ctx: { chosenRoleIndex: 1 } }).nextBoard[8]).toEqual('red');

      expect(getGameStateAfterAiTurn({ board: [
        'blue', null, null,
        null, 'red', 'blue',
        null, null, 'red'
      ], ctx: { chosenRoleIndex: 1 } }).nextBoard[3]).toEqual('red');
    });
    ...
    it('should not place to achieve 3 in a row if possible', () => {
      ...
      const result = getGameStateAfterAiTurn({ board, ctx: { chosenRoleIndex: 0 } });
