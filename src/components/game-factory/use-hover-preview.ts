 ...
 * lives inside a repeated child component. Spread `hoverProps(value)` onto a
 * hoverable element; simply don't attach it to an element that shouldn't drive a
 * preview (e.g. one that is currently disabled/non-interactable).
 */
