  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <DialogPanel className="rounded-sm bg-white dark:bg-slate-800 max-w-sm w-full p-2">
          <header className="flex items-baseline mb-2">
            ...
            <button
              ...
              className="bg-slate-200 dark:bg-slate-700 rounded-sm text-2xl px-1
          ...
          <div
            className="rounded-lg border border-slate-200 dark:border-slate-600
              bg-slate-50 dark:bg-slate-700 p-3 flex flex-col gap-3"
          >
            <ModeSelector
